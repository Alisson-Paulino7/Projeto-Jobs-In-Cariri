      ...
      <div id="tab2" class="tab-content ">
        ...
        <div class="cadastro-inicial">
          ...
          <div class="caixa-input">
            ...
            <input type="date" placeholder="Data de nascimento" name="dtNascimento">
          </div>
          <div class="caixa-input">
        ...
        <div class="btnsDadosPessoais">
          <button onclick="prevTab()" class="btnAnteriorDadosPessoais"style=" background: linear-gradient(to left,  #ff6600, #ffe600);
  color: white;
  font-size: 16px;
  width: 400px;
    height: 60px;
    ...
    outline: none;
    padding-left: 5px;
  margin: 10px;">Anterior</button>
          <input type="button" value="Próximo" onclick="nextTab()" style=" background: linear-gradient(to left,  #ff6600, #ffe600);
  color: white;
  font-size: 16px;
  width: 400px;
    height: 60px;
      ...
      <div id="tab3" class="tab-content ">
        <div class="cadastro-inicial">
          ...
          <div class="check-termos-de-uso">
            <input type="checkbox" name="meucheckbox">
          </div>
          <div class="btn-termos-de-uso">
            <button onclick="prevTab()" style=" background: linear-gradient(to left,  #ff6600, #ffe600);
  color: white;
  font-size: 16px;
  width: 400px;
    height: 60px;
    ...
    padding-left: 5px;
  margin: 10px;">Anterior</button>
            <input type="submit" value="Finalizar cadastro" onclick="nextTab()" style="background: linear-gradient(to left,  #0e8008, #45ad37); width: 400px;
    height: 60px;
    border-radius: 5px;
    border: none;
    outline: none;
...
<style>
  ...
  .cadastro-inicial input[type="button"] {
  ...
  .btnAnteriorDadosPessoais {
    background: linear-gradient(to left, red, #ffe600);
    color: white;
    font-size: 16px;
    width: 180px;
    height: 35px;
